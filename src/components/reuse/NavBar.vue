  ...
  <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        <a
          href="whatsapp://send?text=Hi Rajesh sir,I want to know more about NSHSS&phone=+919447506088&abid=+919447506088">
          <button type="button"
            class="text-white bg-Primary hover:bg-opacity-85 focus:ring-4 focus:outline-none focus:ring-Secondary font-medium rounded-lg text-sm px-4 pr-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-secondary">Connect
            with us</button></a>
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        <ul
          ...
          <li>
            <a href="/"
              class="block py-2 px-3 text-gray-900 bg-Primary rounded md:bg-transparent md:text-gray-900 md:p-0 md:dark:text-blue-500"
